package com.github.eisermann.codexlauncher.startup

import com.github.eisermann.codexlauncher.files.FileOpenService
import com.github.eisermann.codexlauncher.http.HttpTriggerService
import com.github.eisermann.codexlauncher.mcp.IdeContextTracker
import com.github.eisermann.codexlauncher.mcp.McpServer
 ...
 *
 * It also initializes the MCP Server and Context Tracker for the Codex CLI Companion spec.
 *
 * @since 1.0.0
 */
...
class CodexStartupActivity : StartupActivity {
    ...
    override fun runActivity(project: Project) {
        ...
        // MCP Server (Codex Companion Spec)
