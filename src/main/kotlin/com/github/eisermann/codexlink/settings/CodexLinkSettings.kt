package com.github.eisermann.codexlink.settings

import com.github.eisermann.codexlink.cli.CodexArgsBuilder
...
/**
 * Application-level settings service for Codex Link plugin.
 *
 ...
 *
 * Settings are automatically persisted to CodexLink.xml in the IDE's configuration directory.
 *
 * @since 1.0.0
 */

@Service(Service.Level.APP)
@State(name = "CodexLinkSettings", storages = [Storage("CodexLink.xml")])
class CodexLinkSettings : PersistentStateComponent<CodexLinkSettings.State> {
    /**
