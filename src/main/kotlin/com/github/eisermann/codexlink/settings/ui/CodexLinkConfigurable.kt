package com.github.eisermann.codexlink.settings.ui
...
class CodexLinkConfigurable : SearchableConfigurable {
    ...
    private val settings by lazy { service<CodexLinkSettings>() }
    ...
    override fun getId(): String = "com.github.eisermann.codexlink.settings"

    override fun getDisplayName(): String = "Codex Link"
    ...
    override fun createComponent(): JComponent {
        ...
        root = panel {
            ...
            group("Notifications") {
                ...
                row {
                    this.largeComment(
                        "Customize notification sounds and display options in <a href='notifications'>Settings &gt; Appearance &amp; Behavior &gt; Notifications &gt; CodexLink</a>.",
