package com.github.eisermann.codexlink.actions

import com.github.eisermann.codexlink.http.HttpTriggerService
import com.github.eisermann.codexlink.mcp.McpServer
...
import com.github.eisermann.codexlink.terminal.CodexTerminalManager
...
class LaunchCodexAction : AnAction(DEFAULT_TEXT, DEFAULT_DESCRIPTION, null), DumbAware {
    ...
    companion object {
        ...
        private const val NOTIFICATION_TITLE = "Codex Link"
    ...
    private fun launchCodex(project: Project, terminalManager: CodexTerminalManager) {
        ...
        try {
            ...
            val settings = service<CodexLinkSettings>()
    ...
    private fun notify(project: Project, content: String, type: NotificationType) {
        runCatching {
            val group = NotificationGroupManager.getInstance().getNotificationGroup("CodexLink")
