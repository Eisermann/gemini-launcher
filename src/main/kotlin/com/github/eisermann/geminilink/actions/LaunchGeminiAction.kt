package com.github.eisermann.geminilink.actions

import com.github.eisermann.geminilink.http.HttpTriggerService
import com.github.eisermann.geminilink.mcp.McpServer
...
import com.github.eisermann.geminilink.terminal.GeminiTerminalManager
...
class LaunchGeminiAction : AnAction(DEFAULT_TEXT, DEFAULT_DESCRIPTION, null), DumbAware {
    ...
    companion object {
        ...
        private const val NOTIFICATION_TITLE = "Gemini Link"
    ...
    private fun launchGemini(project: Project, terminalManager: GeminiTerminalManager) {
        ...
        try {
            ...
            val settings = service<GeminiLinkSettings>()
    ...
    private fun notify(project: Project, content: String, type: NotificationType) {
        runCatching {
            val group = NotificationGroupManager.getInstance().getNotificationGroup("GeminiLink")
