package com.github.eisermann.geminilink.settings.ui
...
class GeminiLinkConfigurable : SearchableConfigurable {
    ...
    private val settings by lazy { service<GeminiLinkSettings>() }
    ...
    override fun getId(): String = "com.github.eisermann.geminilink.settings"

    override fun getDisplayName(): String = "Gemini Link"
    ...
    override fun createComponent(): JComponent {
        ...
        root = panel {
            ...
            group("Notifications") {
                ...
                row {
                    this.largeComment(
                        "Customize notification sounds and display options in <a href='notifications'>Settings &gt; Appearance &amp; Behavior &gt; Notifications &gt; GeminiLink</a>.",
