package com.github.eisermann.geminilink.settings

import com.github.eisermann.geminilink.cli.GeminiArgsBuilder
...
/**
 * Application-level settings service for Gemini Link plugin.
 * 
 ...
 * 
 * Settings are automatically persisted to GeminiLink.xml in the IDE's configuration directory.
 * 
 * @since 1.0.0
 */

@Service(Service.Level.APP)
@State(name = "GeminiLinkSettings", storages = [Storage("GeminiLink.xml")])
class GeminiLinkSettings : PersistentStateComponent<GeminiLinkSettings.State> {
    /**
